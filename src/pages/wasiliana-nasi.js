...
const Input = ({ placeholder, type, name, className }) => (
  <input
    ...
    className={`p-3 border rounded bg-white text-blue-700 placeholder-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400 ${className}`}
  />
)
  ...
  return (
    <Layout>
      ...
      <div className="max-w-7xl mx-auto mt-10 flex text-white xxs:flex-col sm:flex-row">
        <Fade duration={1200}>
          <div className="bg-dp opacity-70 p-10 rounded-xl w-3/4 mt-5 w-auto">
